  ...
  <div>
    ...
    <div className="about__aboutContainer">
      <div className="about__aboutInner">
        ...
        <div className="about__subtitle">
          <p>I used to design <strong>identity and security</strong> technologies for developers at <strong><a href="https://okta.com" target="_blank">Okta</a></strong> (formerly <a href="https://auth0.com/" target="_blank">Auth0</a>), and before that <strong>cloud-native software delivery and automation</strong> at <strong><a href="https://vmware.com" target="_blank">VMware</a></strong> (formerly <a href="https://en.wikipedia.org/wiki/Pivotal_Software" target="_blank">Pivotal Software</a>).</p>
        </div>
        <div className="about__subtitle">
